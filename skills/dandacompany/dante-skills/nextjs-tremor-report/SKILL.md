...
slug: nextjs-tremor-report
metadata:
  sources:
    - kind: github-dir
      repo: dandacompany/dante-skills
      path: nextjs-tremor-report
      trackingRef: main
      url: https://github.com/dandacompany/dante-skills/tree/main/nextjs-tremor-report
key: dandacompany/dante-skills/nextjs-tremor-report
---
